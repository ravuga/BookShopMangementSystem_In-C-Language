...
char catagories[][15]={"Novels","Short Story","Magzines","Newspaper","Academics","Miscellaneous"};
...
gotoxy(20,11);
printf("\xDB\xDB\xDB\xDB\xB2 4. Buy  Books");
gotoxy(20,13);
...
gotoxy(16,4);
printf("\t MINI PROJECT BY GAURAV KUMAR");
gotoxy(16,5);
printf("\tRK1612A22");
exit(0);
}
...
gotoxy(20,7);
printf("\xDB\xDB\xDB\xDB\xB2 1. Novels");
gotoxy(20,9);
printf("\xDB\xDB\xDB\xDB\xB2 2. Short Story");
gotoxy(20,11);
printf("\xDB\xDB\xDB\xDB\xB2 3. Magzines");
gotoxy(20,13);
printf("\xDB\xDB\xDB\xDB\xB2 4. Newspaper");
gotoxy(20,15);
printf("\xDB\xDB\xDB\xDB\xB2 5. Academics");
gotoxy(20,17);
printf("\xDB\xDB\xDB\xDB\xB2 6. Miscellaneous");
gotoxy(20,19);
...
system("cls");
printf("********************************PURCHASE SECTION**************************");
gotoxy(10,5);
printf("\xDB\xDB\xDB\xDb\xB2 1. Buy a Book");
gotoxy(10,7);
...
system("cls");
gotoxy(15,4);
printf("***Buying Book section***");
gotoxy(10,6);
printf("Enter the Book Id:");
scanf("%d",&t);
fp=fopen("Data.dat","rb");
fs=fopen("Purchase.dat","ab+");
if(checkid(t)==0)
{
	int noOfbook=0;
gotoxy(10,8);
printf("The book record is available");
gotoxy(10,9);
printf("There are %d books in our shop ",a.quantity);
gotoxy(10,10);
...
scanf("%s",a.stname);
gotoxy(10,12);
printf("ENTER THE NO OF BOOKS TO BE PURCHASED ");
scanf("%d",&noOfbook);
gotoxy(10,14);
printf("YOUR TOTAL AMOUNT IS %d ",noOfbook*(int)(a.Price));
gotoxy(10,15);
printf("Press Enter to continue");
Sleep(5);
gotoxy(10,16);
printf("The BOOK of ID %d IS PURCHASED SUCCESSFULLY",a.id);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void viewbooks(void)  //show the list of book persists in shop
{
int i=0,j;
system("cls");
gotoxy(1,1);
...
int checkid(int t)  //check whether the book is exist in shop or not
{
rewind(fp);
while(fread(&a,sizeof(a),1,fp)==1)
if(a.id==t)
